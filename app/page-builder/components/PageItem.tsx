...
type Props = {
    page: Page; focus: boolean; onClick: () => void; onDelete: () => void;
};
...
const PageItem: FC<Props> = ({page, focus, onClick, onDelete}) => {
    ...
    return (<div
            ...
            {...listeners}
            onClick={onClick}
            className={clsx("flex items-center gap-2 px-3 py-1.5 rounded-md border cursor-pointer", "transition-all duration-300 ease-in-out transform-gpu animate-fade-in", {
          ...
          {page.title}
            ...
            <Menu as="div" className="relative ml-auto">
                ...
                <MenuItems
                    ...
                    className="bg-white mt-10 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                >
